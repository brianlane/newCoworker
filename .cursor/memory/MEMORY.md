...
- [A ChatGPT app IS an MCP server](project_chatgpt_app_is_an_mcp_server.md) - v1.0.0 APPROVED Sep 15 2026, not yet Published; click Publish in the OpenAI plugins dashboard; flip install copy after publish; sandbox texts Brian BY DESIGN
