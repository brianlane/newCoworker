...
- [HQ postal-address waiver](project_hq_postal_address_waiver.md) - HQ is Standard, so the Enterprise plan waiver does not apply; exempt by HQ_BUSINESS_ID; footer is the unsubscribe line when no address exists; do not widen to other Standard tenants
