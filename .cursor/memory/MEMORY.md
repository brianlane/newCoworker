...
- [MCP marketing draft tools](project_mcp_marketing_drafts.md) - paragraphs only, footer in code; one write straight to drafted; findings empty so Write it again refuses; auto mode SENDS; five guarded places per new MCP tool
