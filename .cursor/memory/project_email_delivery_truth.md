...
prospect ledger stayed at `sent`, which is exactly what the follow-up
sequence selects, so a hard bounce (ASAP Plumbing, 2026-08-31) was queued to
be re-mailed. The Aug 28 one-shot
...
mail), skip a row that already replied or already finished the sequence. The one-shot
