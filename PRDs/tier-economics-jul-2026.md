...
_Markdown snapshot of the "Standard On KVM2 Economics" canvas, updated Jul 5 2026
(evening) after PRs #360–#365 merged and deployed. Sources: live Hostinger
catalog + Telnyx 90-day detailed records + Amy's Supabase usage rollups
(`debug/pull-cost-data.ts`, pulled Jul 2 2026), Gemini Live ~$0.0225/min,
Stripe 2.9% + $0.30._
...
| KVM 2 (standard default) | $24.49 | $16.99 | $14.99 |
| KVM 4 (escalation) | $42.99 | $30.99 | $28.99 |
| KVM 8 (enterprise/escalation) | $73.99 | $53.99 | $49.99 |
...
| --- | --- | --- | --- | --- |
| **Starter $19.99 biennial (relaunched)** | KVM1 2-yr $7.99 | ≈ +$9.0/mo | ≈ −$2.9/mo | worst case covered ~7× by the one-time $19.50 10DLC fee; over-cap AI **refuses** (no local model) |
| Starter $19.99, KVM1 monthly SKU | $11.99 | ≈ +$5.0/mo | ≈ −$6.9/mo | real cost until term-buying ships; typical tenant still positive |
...
- **SMS cap 750 → 500, 10 voice min kept** (PR #347).
...
## Execution status (Jul 5 2026, evening)
