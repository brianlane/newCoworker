...
is honored only while WhatsApp can actually deliver — connected, channel on,
never for a page redirected to a teammate's phone — recording the SMS row as
`skipped: whatsapp_preferred`), the dashboard coworker `send_whatsapp` tool
