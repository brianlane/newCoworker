...
| Truly Insurance | [truly-insurance.md](truly-insurance.md) | Commercial insurance, Privyr email leads, renewals. All flows currently off |
...
Not dossiered yet (small, low-touch): Scar Fairy, and the Zoom / Meta / Google
reviewer sandboxes. Add a file when one of them takes real operating effort.
