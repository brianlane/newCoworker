 ...
 * overstate what ships. It lives in the (marketing) route group (which
 * provides the client-message boundary the nav needs), while its sibling
 * /security/vulnerability-disclosure keeps its LegalPage chrome outside
 * the group; the two segments do not collide because only this one
 * defines the /security page itself.
 */
