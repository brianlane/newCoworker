...
import { DialHeadroomCard } from "@/components/dashboard/DialHeadroomCard";
...
export default async function BusinessSettingsPage() {
  ...
  const telnyxSettings = business ? await getBusinessTelnyxSettings(business.id) : null;
    ...
    >
      ...
      {business && (
        <DialHeadroomCard
          ...
          initialHeadroom={telnyxSettings?.voice_outbound_dial_headroom ?? null}
        />
      )}
