...
export const INDUSTRIES: Industry[] = [
    ...
    useCases: [
      {
        ...
        description:
          "Every inquiry is qualified on the first call: buying or selling, timeline, pre-approval, neighborhood — captured and logged before you even see the notification.",
        Icon: Users
      },
      {
  ...
  },
  {
    ...
    subheadline:
      "Front desks get slammed; patients hang up. Your AI coworker answers every call, books and confirms appointments, and handles after-hours questions — on infrastructure dedicated to your practice.",
    useCases: [
      {
      ...
      },
      {
        ...
        description:
          "A dedicated server per practice — conversations aren't pooled with thousands of other businesses.",
        Icon: ShieldCheck
      },
      {
