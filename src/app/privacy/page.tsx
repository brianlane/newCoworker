    ...
    >
      ...
      <LegalSection title="2. Information We Collect">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>Derived profile data, such as AI-maintained summaries and structured facts about a business&apos;s contacts, built from conversations and interactions across channels.</li>
          <li>Prospect data gathered on a business&apos;s behalf from public sources, such as business directories (for example Google Places) and public websites, when the business enables outreach features.</li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="7. How We Share Information">
        ...
        <p>
          Based on the current product architecture, service providers we use to operate the platform include
          Supabase (authentication and database), Stripe (billing and payments), Telnyx (telephony: voice, SMS,
        ...
        <p>
          ...
          with hashed identifiers (email, phone number) to support that business&apos;s advertising measurement.
        </p>
      </LegalSection>
      ...
      <LegalSection title="11. Data Retention">
        <p>
          ...
          business needs. By default, content associated with an active account (such as conversation history)
          is retained for the life of the account unless a shorter retention window is configured for that
          account. Certain operational logs are kept for fixed periods (for example, about 90 days) and then
          removed. You can request deletion of personal information at any time by following our{" "}
          <a className="text-signal-teal hover:text-parchment" href="/privacy/data-deletion">data deletion instructions</a>.
        </p>
      </LegalSection>
      ...
      <LegalSection title="13. International Processing">
        <p>
          ...
          laws where you reside. For enterprise plans, regional hosting options (for example Canadian data
          residency) may be available on request.
        </p>
      </LegalSection>
      ...
      <LegalSection title="14. Your Rights and Choices">
        ...
        <p>
          ...
          For deletion requests, you can also follow our{" "}
          <a className="text-signal-teal hover:text-parchment" href="/privacy/data-deletion">data deletion instructions</a>.
