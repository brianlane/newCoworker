...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: { path: string; priority: number; enOnly?: boolean }[] = [
    ...
    { path: "/after-hours-answering", priority: 0.8 },
    { path: "/ai-answering-service", priority: 0.8 },
    ...
    // A real index since the push guide made /docs a destination rather than
    // a redirect, which is why it was previously absent from this list.
