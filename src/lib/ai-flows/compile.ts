...
export const FLOW_COMPILE_SYSTEM_PROMPT = [
  ...
  "{{trigger.url}}, {{trigger.windowText}}, {{trigger.from}}. {{vars.actions_taken}}",
  ...
  "late-night lead is emailed instead of texted (or the text waits until",
  'morning). A send_email step may carry "fromConnectionId":"<uuid>" to send',
