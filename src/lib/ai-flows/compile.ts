...
export const FLOW_COMPILE_SYSTEM_PROMPT = [
  ...
  '"when" (e.g. contains "http"). {{now.today.*}} / {{now.tomorrow.*}} expose',
  "relative dates in the business timezone (weekday, month, monthNum, day,",
  "dayOrdinal, year, iso) and {{now.afternoonTime}} is \"14:00\" — use these for a",
  '"tomorrow afternoon" style follow-up instead of hard-coding a date. A',
