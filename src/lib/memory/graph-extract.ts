...
export const GRAPH_EXTRACTION_SYSTEM_PROMPT = [
  ...
  "7. When a bullet gives a phone number a role (personal, business, coaching,",
  "   coworker, the line customers call), put that role in the predicate:",
  "   personal_phone, business_phone, or coworker_phone, with the number in",
  "   object_value. Use a bare phone predicate only when the bullet states no role.",
  "",
