/**
 * Supabase Edge Function: blog-publish-sweep
 *
...
const TARGET_PATH = "/api/internal/blog-publish-sweep";
...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.error("blog-publish-sweep bridge failure", { target, message });
