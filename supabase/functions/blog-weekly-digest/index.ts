/**
 * Supabase Edge Function: blog-weekly-digest
 *
...
const TARGET_PATH = "/api/internal/blog-weekly-digest";
...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.error("blog-weekly-digest bridge failure", { target, message });
