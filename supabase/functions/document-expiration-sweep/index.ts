/**
 * Supabase Edge Function: document-expiration-sweep
 *
 * Cron bridge for the daily business-documents expiration reminders.
...
const TARGET_PATH = "/api/internal/document-expiration-sweep";
  ...
  try {
    const res = await fetch(target, {
      ...
      headers: {
        ...
        "X-Cron-Job": "document-expiration-sweep",
    ...
    console.error("document-expiration-sweep bridge failure", { target, message });
