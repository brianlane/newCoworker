/**
 * Supabase Edge Function: messenger-jobs-sweep
 *
...
const TARGET_PATH = "/api/internal/messenger-worker";
  ...
  try {
    const res = await fetch(target, {
      ...
      headers: {
        ...
        "X-Cron-Job": "messenger-jobs-sweep",
    ...
    console.error("messenger-jobs-sweep bridge failure", { target, message });
