/**
 * Supabase Edge Function: monthly-intro-nudge-sweep
 *
 * Cron bridge for the daily month-to-month first-month intro nudge.
 ...
 * same indirection as document-expiration-sweep.
 *
 * Environment:
...
const TARGET_PATH = "/api/internal/monthly-intro-nudge-sweep";
  ...
  try {
    const res = await fetch(target, {
      ...
      headers: {
        ...
        "X-Cron-Job": "monthly-intro-nudge-sweep",
    ...
    console.error("monthly-intro-nudge-sweep bridge failure", { target, message });
