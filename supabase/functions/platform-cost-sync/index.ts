/**
 * Supabase Edge Function: platform-cost-sync
 *
 * Cron bridge for the daily platform cost sync (admin Costs/Usage views).
...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.error("platform-cost-sync bridge failure", { target, message });
