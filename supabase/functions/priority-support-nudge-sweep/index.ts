/**
 * Supabase Edge Function: priority-support-nudge-sweep
 *
 * Cron bridge for the daily priority support expiry nudge.
 ...
 * same indirection as contract-term-nudge-sweep.
 *
 * Environment:
...
const TARGET_PATH = "/api/internal/priority-support-nudge-sweep";
  ...
  try {
    const res = await fetch(target, {
      ...
      headers: {
        ...
        "X-Cron-Job": "priority-support-nudge-sweep",
    ...
    console.error("priority-support-nudge-sweep bridge failure", { target, message });
