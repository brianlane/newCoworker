/**
 * Supabase Edge Function: social-post-sweep
 *
 * Cron bridge for the per-minute Instagram post publisher. pg_cron hits
 ...
 * publishing logic (the Meta Graph client lives in the Node runtime),
...
const TARGET_PATH = "/api/internal/social-post-sweep";
...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.error("social-post-sweep bridge failure", { target, message });
