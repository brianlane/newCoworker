/**
 * Supabase Edge Function: usage-pack-auto-reload-sweep
 *
 * Cron bridge for the usage-pack auto-reload sweep.
 ...
 * which holds the sweep logic (Stripe SDK + the tier/env cap contracts
 * need the Node runtime), same indirection as contract-term-nudge-sweep.
 *
 * Environment:
...
const TARGET_PATH = "/api/internal/usage-pack-auto-reload-sweep";
  ...
  try {
    const res = await fetch(target, {
      ...
      headers: {
        ...
        "X-Cron-Job": "usage-pack-auto-reload-sweep",
    ...
    console.error("usage-pack-auto-reload-sweep bridge failure", { target, message });
