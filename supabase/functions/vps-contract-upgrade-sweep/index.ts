/**
 * Supabase Edge Function: vps-contract-upgrade-sweep
 *
 * Cron bridge for the daily fleet VPS contract-upgrade sweep.
 *
...
const TARGET_PATH = "/api/internal/vps-contract-upgrade-sweep";
  ...
  try {
    const res = await fetch(target, {
      ...
      headers: {
        ...
        "X-Cron-Job": "vps-contract-upgrade-sweep",
        Origin: appUrl
      },
      body: "{}",
    ...
    console.error("vps-contract-upgrade-sweep bridge failure", { target, message });
