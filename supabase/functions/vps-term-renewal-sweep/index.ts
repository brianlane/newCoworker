/**
 * Supabase Edge Function: vps-term-renewal-sweep
 *
 * Cron bridge for the daily fleet VPS term-renewal sweep.
 *
  ...
  try {
    const res = await fetch(target, {
      ...
      headers: {
        ...
        "X-Cron-Job": "vps-term-renewal-sweep",
        Origin: appUrl
      },
      body: "{}",
    ...
    console.error("vps-term-renewal-sweep bridge failure", { target, message });
