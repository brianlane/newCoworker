-- Align the live increment_usage function with the current repo logic.
-- This is a follow-up migration because 20260328000001 was already applied
-- remotely before its SQL was edited locally.
