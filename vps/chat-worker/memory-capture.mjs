...
export const OWNER_MEMORY_SYSTEM_PROMPT = [
  ...
  "    owner states it)",
  "",
  "When the owner gives a phone number a role (personal, business, coaching line,",
  "coworker line, the number customers call), keep that role in the same bullet",
  "as the number. Never save a bare number that drops the role they stated.",
  "",
